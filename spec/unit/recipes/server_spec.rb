...
describe 'icinga2::server' do
  ...
  shared_examples_for 'icinga' do
    context 'all_platforms' do
      %w(attributes server_os_packages core_install core_config server_config server_ido_schema service).each do |r|
  ...
  context 'rhel' do
    ...
    %w(gcc gcc-c++ glibc glibc-common mailx php php-devel gd gd-devel libjpeg libjpeg-devel libpng libpng-devel php-gd php-fpm php-cli php-pear php-xmlrpc php-xsl php-pdo php-soap php-ldap php-mysql php-pgsql php-intl git php-pecl-imagick).each do |p|
  ...
  context 'ubuntu' do
    ...
    %w(g++ mailutils php5 php5-cli php5-fpm build-essential libgd2-xpm-dev libjpeg62 libpng12-0 libpng12-dev libapache2-mod-php5 git-core imagemagick php5-imagick php-pear php5-xmlrpc php5-xsl php5-mysql php-soap php5-gd php5-ldap php5-pgsql php5-intl).each do |p|
      it "install package #{p}" do
        expect(chef_run).to install_package(p)
      end
    end
