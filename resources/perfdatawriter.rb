...
attribute :host_perfdata_path,      :kind_of => String, :default => nil
attribute :service_perfdata_path,   :kind_of => String, :default => nil
attribute :host_temp_path,          :kind_of => String, :default => nil
