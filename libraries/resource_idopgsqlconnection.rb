...
class Chef
  class Resource
    ...
    class Icinga2Idopgsqlconnection < Chef::Resource
      identity_attr :name
      ...
      def initialize(name, run_context = nil)
        ...
        @provides = :icinga2_idopgsqlconnection
        @provider = Chef::Provider::Icinga2Idopgsqlconnection
        @action = :create
...
class Chef
  class Provider
    # provides icinga2_idopgsqlconnection
    class Icinga2Idopgsqlconnection < Chef::Provider::LWRPBase
      provides :icinga2_idopgsqlconnection if respond_to?(:provides)
