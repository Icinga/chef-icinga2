    ...
    class Icinga2Applydependency < Chef::Resource
      ...
      def resource_properties(arg = nil)
        set_or_return(
          ...
          :kind_of => Array,
          :default => %w(object_relation object_type parent_host_name child_host_name parent_service_name child_service_name disable_checks disable_notifications period states assign_where ignore_where)
        )
      end
    end
  end
